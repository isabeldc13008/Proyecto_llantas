...
builder.Services.AddAuthorization(o =>
{
    ...
    o.AddPolicy("Alertas.Parametrizar",p=>p.RequireRole("ADMINISTRADOR","SUPERVISOR_ADMINISTRADOR").RequireClaim("permiso","alertas.parametrizar"));
    ...
    o.AddPolicy("Operaciones.Aprobar",p=>p.RequireRole("ADMINISTRADOR","SUPERVISOR_ADMINISTRADOR").RequireClaim("permiso","operaciones.aprobar"));
