...
namespace SistemaLlantas.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260918131215_AddScheduledMountSets")]
    partial class AddScheduledMountSets
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SistemaLlantas.Domain.Entities.ActividadProgramada", b =>
                {
                    ...
                    b.HasIndex("TecnicoUsuarioId", "VehiculoId", "TipoActividad", "FechaProgramada", "PosicionVehiculoId")
                        .IsUnique()
                        .HasDatabaseName("IX_ActividadProgramada_TrabajoPosicion")
            ...
            modelBuilder.Entity("SistemaLlantas.Domain.Entities.SolicitudOperacion", b =>
                {
                    ...
                    b.Property<Guid?>("GrupoOperacionId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("GGrupoOperacionId");
            ...
            modelBuilder.Entity("SistemaLlantas.Domain.Entities.UsuarioSistema", b =>
                {
                    ...
                    b.Property<bool>("DebeCambiarClave")
                        ...
                        .HasColumnName("BDebeCambiarClave");
            ...
            modelBuilder.Entity("SistemaLlantas.Domain.Entities.ParametroAlerta", b =>
                {
                    b.HasOne("SistemaLlantas.Domain.Entities.Centro", null)
                        .WithMany()
                        .HasForeignKey("CentroId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
