...
public sealed class AlertasConfiguration:IEntityTypeConfiguration<ParametroAlerta>,IEntityTypeConfiguration<AlertaInspeccion>,IEntityTypeConfiguration<AlertaHistorial>
{
 ...
 b.Property(x=>x.Nombre).HasMaxLength(150).IsRequired();b.Property(x=>x.Tipo).HasMaxLength(50).IsRequired();b.Property(x=>x.Descripcion).HasMaxLength(1000).IsRequired();b.Property(x=>x.Operador).HasMaxLength(2).IsRequired();b.Property(x=>x.Prioridad).HasMaxLength(10).IsRequired();b.HasOne<Centro>().WithMany().HasForeignKey(x=>x.CentroId).OnDelete(DeleteBehavior.Restrict);}
