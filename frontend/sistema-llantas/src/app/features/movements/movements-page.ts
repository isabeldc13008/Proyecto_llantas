...
export class MovementsPage implements OnInit {
 ...
 async loadVehicle(){this.assignments=[];this.resetSelection();this.detail.set(null);this.available.set([]);this.mileage=null;await this.refresh();}
