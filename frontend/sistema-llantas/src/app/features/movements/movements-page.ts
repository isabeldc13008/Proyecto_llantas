...
@Component({host:{class:'edinsa-workflow'},styleUrls:['../../shared/operational-workflow.scss'],selector:'app-movements-page',imports:[CommonModule,FormsModule,VehicleAxleDiagram],template:`
